...
function ExpandedFeaturesRight() {
    ...
    return (
        <section className={`w-full md:min-h-[22rem] flex md:flex-row my-[3rem] xs:flex-col `}>
            <div className={`md:w-[50%] h-full flex flex-col items-start justify-between p-2 xs:w-[98%]`} data-aos = "fade-right">
                <h1 className={`md:text-[2rem] font-[1000] text-[#1e95d4] xs:text-lg`}>Easy And Transparent Ethereum-based Grading System</h1>
            ...
            <div className={`md:w-[50%] h-full flex items-center justify-center xs:w-[98%] `} data-aos = "fade-left">
